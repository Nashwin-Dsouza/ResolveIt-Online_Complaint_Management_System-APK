# PowerShell script to build Release APK with production environment
Write-Host "========================================" -ForegroundColor Green
Write-Host "Building ResolveIt Release APK (Production)" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
...
if ($LASTEXITCODE -eq 0) {
    ...
    if (Test-Path $originalApkPath) {
        ...
        Write-Host ""
        Write-Host "========================================" -ForegroundColor Green
        Write-Host "Release APK Build Successful! (Production)" -ForegroundColor Green
        Write-Host "========================================" -ForegroundColor Green
